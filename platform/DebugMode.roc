...
DebugMode :: [].{
	...
	wait! = |{}| Host.wait!(debug_mode_wait_time)
	...
	#   }
	#
	# flash_current_frame! : Str => Try({} ,[JsReturnTypeError( Str ), WebDriverError( Str )])
	...
	#   }
	#
	# show_debug_message_in_browser! : Str, Str => Try({} ,[WebDriverError ( Str ), JsReturnTypeError ( Str )])
